  ...
  @if(session('success'))
    ...
    <div style="min-height:75vh; display:flex; flex-direction:column; align-items:center; justify-content:center;">
        ...
        <div style="margin-bottom:24px; text-align:center;">
            <h1 style="font-size:1.25rem; font-weight:700; color:#1e293b;">Tambah Author</h1>
            <p style="font-size:0.8rem; color:#94a3b8; margin-top:3px;">Tambahkan penulis buku baru</p>
        </div>
